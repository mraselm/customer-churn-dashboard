...
This project is currently distributed as part of the customer churn dashboard repository. Add a `LICENSE` file if you want to publish it under a specific open-source license.
